...
#if letters end so to change the letters in between the game
def listcheck(lis): 
    lisaa=globals()[lis] 
    if len(lisaa)==0: 
        ...
        if xaa!=lis: 
            let.clear() 
            let.append(xaa) 
            tobespoken="the letter has been changed, the new letter is: ",xaa 
            print("the letter has been changed, the new letter is: ",xaa) 
            speakf(tobespoken)                                                                                          #female 
...
speakf(''' 
welcome to atlas. 
what can we call you''')                                                                                    #female 
name=input("Enter Username: ") 
usercallout="alright",name,"let's play" 
speakf(usercallout) 
speakm("i am max; and i will be your opponent")                             #male 
speakf(''' 
A. 
T. 
L. 
